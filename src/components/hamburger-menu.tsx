...
export function HamburgerMenu() {
  ...
  return (
    <>
      ...
      {/* サイドメニュー */}
      <div className={`
        fixed top-0 left-0 h-full w-80 bg-card bg-white dark:bg-zinc-900 border-r shadow-lg transform transition-transform duration-300 ease-in-out z-50 md:hidden
